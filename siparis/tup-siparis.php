    ...
    <section class="pricing-table section">
      <div class="container">
        <div class="row">
          <!-- Single Table -->
          <?php
          $sql = "SELECT isim, fiyat, detay, aciklama1, aciklama2, aciklama3 FROM tbl_urun_tup";
          ...
          if ($result->num_rows > 0) { //veri sıfırdan büyük ise...
            ...
            <div class="single-table">
              ...
              <a class="btn" href="detay?kategori=tüp&cins=<?php echo $row['isim'] ?>&fiyat=<?php echo $row['fiyat'] ?>&detay=<?php echo $row['detay'] ?>">Satın Al</a>
              </div>
              <!-- Table Bottom -->
            </div>
          </div>
